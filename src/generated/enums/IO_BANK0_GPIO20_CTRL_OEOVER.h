...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO20_CTRL_OEOVER_H
#define RP2040_ENUMS_IO_BANK0_GPIO20_CTRL_OEOVER_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO20_CTRL_OEOVER instance)
{
