...
#pragma once
#ifndef RP2040_ENUMS_CLOCKS_CLK_GPOUT2_CTRL_AUXSRC_H
...
inline std::ostream &operator<<(std::ostream &stream, CLOCKS_CLK_GPOUT2_CTRL_AUXSRC instance)
{
 ...
 */
inline bool from_string(const char *data, CLOCKS_CLK_GPOUT2_CTRL_AUXSRC &output)
{
    bool result = false;
