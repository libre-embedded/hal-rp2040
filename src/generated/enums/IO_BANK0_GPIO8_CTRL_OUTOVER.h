...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO8_CTRL_OUTOVER_H
#define RP2040_ENUMS_IO_BANK0_GPIO8_CTRL_OUTOVER_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO8_CTRL_OUTOVER instance)
{
