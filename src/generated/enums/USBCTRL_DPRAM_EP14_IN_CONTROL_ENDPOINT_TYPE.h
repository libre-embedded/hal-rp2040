...
#pragma once
#ifndef RP2040_ENUMS_USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE_H
#define RP2040_ENUMS_USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE_H
...
/**
 * Converts USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE instance)
{
...
inline std::ostream &operator<<(std::ostream &stream, USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE instance)
{
...
/**
 * Converts a C string to USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, USBCTRL_DPRAM_EP14_IN_CONTROL_ENDPOINT_TYPE &output)
{
    bool result = false;
