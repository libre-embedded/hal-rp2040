...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO6_CTRL_FUNCSEL_H
#define RP2040_ENUMS_IO_BANK0_GPIO6_CTRL_FUNCSEL_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO6_CTRL_FUNCSEL instance)
{
