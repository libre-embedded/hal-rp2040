...
#pragma once
#ifndef RP2040_ENUMS_PADS_BANK0_GPIO1_DRIVE_H
#define RP2040_ENUMS_PADS_BANK0_GPIO1_DRIVE_H
...
inline std::ostream &operator<<(std::ostream &stream, PADS_BANK0_GPIO1_DRIVE instance)
{
