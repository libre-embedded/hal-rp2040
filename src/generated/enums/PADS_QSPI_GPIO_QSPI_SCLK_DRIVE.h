...
#pragma once
#ifndef RP2040_ENUMS_PADS_QSPI_GPIO_QSPI_SCLK_DRIVE_H
#define RP2040_ENUMS_PADS_QSPI_GPIO_QSPI_SCLK_DRIVE_H
...
inline std::ostream &operator<<(std::ostream &stream, PADS_QSPI_GPIO_QSPI_SCLK_DRIVE instance)
{
