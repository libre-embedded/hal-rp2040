...
#pragma once
#ifndef RP2040_ENUMS_IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL_H
...
inline const char *to_string(IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL instance)
{
    ...
    case IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL::sio_31:
        result = "sio_31";
        break;
    case IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL::null_:
        result = "null_";
        break;
    }
...
inline std::ostream &operator<<(std::ostream &stream, IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL instance)
{
 ...
 */
inline bool from_string(const char *data, IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL &output)
{
    bool result = false;
    ...
    {
        output = IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL::null_;
    }
