...
#pragma once
#ifndef RP2040_ENUMS_XIP_SSI_SPI_CTRLR0_INST_L_H
...
{
    NONE /*!< No instruction */,
    _4B = 1 /*!< 4-bit instruction */,
    _8B = 2 /*!< 8-bit instruction */,
    _16B = 3 /*!< 16-bit instruction */
};
...
inline std::ostream &operator<<(std::ostream &stream, XIP_SSI_SPI_CTRLR0_INST_L instance)
{
