...
#pragma once
#ifndef RP2040_ENUMS_DMA_CH2_CTRL_TRIG_DATA_SIZE_H
#define RP2040_ENUMS_DMA_CH2_CTRL_TRIG_DATA_SIZE_H
...
inline std::ostream &operator<<(std::ostream &stream, DMA_CH2_CTRL_TRIG_DATA_SIZE instance)
{
