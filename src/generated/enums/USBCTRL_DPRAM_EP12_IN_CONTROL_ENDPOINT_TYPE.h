...
#pragma once
#ifndef RP2040_ENUMS_USBCTRL_DPRAM_EP12_IN_CONTROL_ENDPOINT_TYPE_H
#define RP2040_ENUMS_USBCTRL_DPRAM_EP12_IN_CONTROL_ENDPOINT_TYPE_H
 ...
 */
inline const char *to_string(USBCTRL_DPRAM_EP12_IN_CONTROL_ENDPOINT_TYPE instance)
{
...
inline std::ostream &operator<<(std::ostream &stream, USBCTRL_DPRAM_EP12_IN_CONTROL_ENDPOINT_TYPE instance)
{
 ...
 */
inline bool from_string(const char *data, USBCTRL_DPRAM_EP12_IN_CONTROL_ENDPOINT_TYPE &output)
{
    bool result = false;
