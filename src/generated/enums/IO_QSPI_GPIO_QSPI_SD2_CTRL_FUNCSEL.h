...
inline std::ostream &operator<<(std::ostream &stream, IO_QSPI_GPIO_QSPI_SD2_CTRL_FUNCSEL instance)
{
 ...
 */
inline bool from_string(const char *data, IO_QSPI_GPIO_QSPI_SD2_CTRL_FUNCSEL &output)
{
    bool result = false;
