...
#pragma once
#ifndef RP2040_ENUMS_PWM_CH2_CSR_DIVMODE_H
#define RP2040_ENUMS_PWM_CH2_CSR_DIVMODE_H
...
inline std::ostream &operator<<(std::ostream &stream, PWM_CH2_CSR_DIVMODE instance)
{
