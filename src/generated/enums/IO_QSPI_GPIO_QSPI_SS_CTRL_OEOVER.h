...
#pragma once
#ifndef RP2040_ENUMS_IO_QSPI_GPIO_QSPI_SS_CTRL_OEOVER_H
#define RP2040_ENUMS_IO_QSPI_GPIO_QSPI_SS_CTRL_OEOVER_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_QSPI_GPIO_QSPI_SS_CTRL_OEOVER instance)
{
 ...
 */
inline bool from_string(const char *data, IO_QSPI_GPIO_QSPI_SS_CTRL_OEOVER &output)
{
    bool result = false;
