...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO24_CTRL_INOVER_H
#define RP2040_ENUMS_IO_BANK0_GPIO24_CTRL_INOVER_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO24_CTRL_INOVER instance)
{
