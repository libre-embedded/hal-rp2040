...
#pragma once
#ifndef RP2040_ENUMS_DMA_CH5_CTRL_TRIG_RING_SIZE_H
#define RP2040_ENUMS_DMA_CH5_CTRL_TRIG_RING_SIZE_H
...
inline std::ostream &operator<<(std::ostream &stream, DMA_CH5_CTRL_TRIG_RING_SIZE instance)
{
