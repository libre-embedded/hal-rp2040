...
#pragma once
#ifndef RP2040_ENUMS_PADS_QSPI_GPIO_QSPI_SD0_DRIVE_H
#define RP2040_ENUMS_PADS_QSPI_GPIO_QSPI_SD0_DRIVE_H
...
inline std::ostream &operator<<(std::ostream &stream, PADS_QSPI_GPIO_QSPI_SD0_DRIVE instance)
{
 ...
 */
inline bool from_string(const char *data, PADS_QSPI_GPIO_QSPI_SD0_DRIVE &output)
{
    bool result = false;
