...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO11_CTRL_IRQOVER_H
#define RP2040_ENUMS_IO_BANK0_GPIO11_CTRL_IRQOVER_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO11_CTRL_IRQOVER instance)
{
