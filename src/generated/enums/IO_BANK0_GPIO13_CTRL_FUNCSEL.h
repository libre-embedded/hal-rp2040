...
#pragma once
#ifndef RP2040_ENUMS_IO_BANK0_GPIO13_CTRL_FUNCSEL_H
#define RP2040_ENUMS_IO_BANK0_GPIO13_CTRL_FUNCSEL_H
...
inline std::ostream &operator<<(std::ostream &stream, IO_BANK0_GPIO13_CTRL_FUNCSEL instance)
{
