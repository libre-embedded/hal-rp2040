...
#pragma once
#ifndef RP2040_ENUMS_BUSCTRL_PERFSEL2_PERFSEL2_H
#define RP2040_ENUMS_BUSCTRL_PERFSEL2_PERFSEL2_H
...
inline std::ostream &operator<<(std::ostream &stream, BUSCTRL_PERFSEL2_PERFSEL2 instance)
{
