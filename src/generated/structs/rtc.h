...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 17;   /*!< rtc's identifier. */
     ...
     */
    inline void set_CLKDIV_M1(uint16_t value) volatile
    {
...
static_assert(ifgen_struct<rtc>);
