...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 33;   /*!< xosc's identifier. */
...
WARNING: setup the irq before selecting dormant mode */
    ...
    std::array<const uint32_t, 3> reserved_padding0 = {};
    uint32_t COUNT; /*!< (read-write) A down counter running at the xosc
frequency which counts to zero and stops. To start the counter write a non-zero
value. Can be used for short software pauses when setting up time sensitive
hardware. */
