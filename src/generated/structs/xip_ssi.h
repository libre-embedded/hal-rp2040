...
#pragma once
#ifndef RP2040_STRUCTS_XIP_SSI_H
 ...
 * the APB read request. This feature is applicable only in enhanced SPI modes.
 ...
 * Instruments Synchronous Serial Protocol or National Semiconductor Microwire.
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 35;    /*!< xip_ssi's identifier. */
     ...
     * Number of data frames
     */
    inline void set_CTRLR1(uint16_t value) volatile
    {
     ...
     * SSI enable
     */
    inline bool get_SSIENR() volatile
    {
        return SSIENR & 1u;
    }
     ...
     * SSI enable
     */
    inline void set_SSIENR() volatile
    {
        SSIENR |= 1u;
    }
     ...
     * SSI enable
     */
    inline void clear_SSIENR() volatile
    {
        SSIENR &= ~(1u);
    }
     ...
     * SSI enable
     */
    inline void toggle_SSIENR() volatile
    {
        SSIENR ^= 1u;
    }
     ...
     * SSI clock divider
     */
    inline void set_BAUDR(uint16_t value) volatile
    {
        uint32_t curr = BAUDR;
     ...
     * Transmit FIFO threshold
     */
    inline void set_TXFTLR(uint8_t value) volatile
    {
     ...
     * Receive FIFO threshold
     */
    inline void set_RXFTLR(uint8_t value) volatile
    {
     ...
     */
    inline bool get_TXOICR() volatile
    {
        return TXOICR & 1u;
    }
     ...
     */
    inline bool get_RXOICR() volatile
    {
        return RXOICR & 1u;
    }
     ...
     */
    inline bool get_RXUICR() volatile
    {
        return RXUICR & 1u;
    }
     ...
     */
    inline bool get_MSTICR() volatile
    {
        return MSTICR & 1u;
    }
     ...
     * Transmit data watermark level
     */
    inline void set_DMATDLR(uint8_t value) volatile
    {
     ...
     * Receive data watermark level (DMARDLR+1)
     */
    inline void set_DMARDLR(uint8_t value) volatile
    {
     ...
     * RXD sample delay (in SCLK cycles)
     */
    inline void set_RX_SAMPLE_DLY(uint8_t value) volatile
    {
    ...
    {
        return XIP_SSI_SPI_CTRLR0_TRANS_TYPE(SPI_CTRLR0 & 0b11u);
    }
     ...
     *
     * Wait cycles between control frame transmit and data reception (in SCLK
     * cycles)
     */
     ...
     *
     * SPI Command to send in XIP mode (INST_L = 8-bit) or to append to Address
     * (INST_L = 0-bit)
     */
     ...
     * TXD drive edge
     */
    inline void set_TXD_DRIVE_EDGE(uint8_t value) volatile
    {
...
static_assert(ifgen_struct<xip_ssi>);
