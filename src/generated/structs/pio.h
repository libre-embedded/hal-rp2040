...
in the chip datasheet, but are also exposed here. */
  ...
  machine 0   Frequency = clock freq / (CLKDIV_INT + CLKDIV_FRAC / 256) */
...
addressed by state machine 0's program counter Write to execute an instruction
immediately (including jumps) and then resume execution. */
  ...
  machine 1   Frequency = clock freq / (CLKDIV_INT + CLKDIV_FRAC / 256) */
...
addressed by state machine 1's program counter Write to execute an instruction
immediately (including jumps) and then resume execution. */
    uint32_t SM1_PINCTRL;  /*!< (read-write) State machine pin control */
    uint32_t SM2_CLKDIV;   /*!< (read-write) Clock divisor register for state
  machine 2   Frequency = clock freq / (CLKDIV_INT + CLKDIV_FRAC / 256) */
...
addressed by state machine 2's program counter Write to execute an instruction
immediately (including jumps) and then resume execution. */
    uint32_t SM2_PINCTRL;  /*!< (read-write) State machine pin control */
    uint32_t SM3_CLKDIV;   /*!< (read-write) Clock divisor register for state
  machine 3   Frequency = clock freq / (CLKDIV_INT + CLKDIV_FRAC / 256) */
...
addressed by state machine 3's program counter Write to execute an instruction
immediately (including jumps) and then resume execution. */
