...
#pragma once
#ifndef RP2040_STRUCTS_WATCHDOG_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 30;   /*!< watchdog's identifier. */
   ...
   watchdog is triggered. The watchdog can be triggered in software. */
     ...
     * when the watchdog is triggered. The watchdog can be triggered in
     * software.
     */
