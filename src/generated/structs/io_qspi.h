...
struct io_qspi
{
    ...
    inline void get_GPIO_QSPI_SCLK_CTRL(
        IO_QSPI_GPIO_QSPI_SCLK_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SCLK_CTRL;
    ...
    inline void get_GPIO_QSPI_SS_CTRL(
        IO_QSPI_GPIO_QSPI_SS_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SS_CTRL;
    ...
    inline void get_GPIO_QSPI_SD0_CTRL(
        IO_QSPI_GPIO_QSPI_SD0_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SD0_CTRL;
    ...
    inline void get_GPIO_QSPI_SD1_CTRL(
        IO_QSPI_GPIO_QSPI_SD1_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SD1_CTRL;
    ...
    inline void get_GPIO_QSPI_SD2_CTRL(
        IO_QSPI_GPIO_QSPI_SD2_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SD2_CTRL;
    ...
    inline void get_GPIO_QSPI_SD3_CTRL(
        IO_QSPI_GPIO_QSPI_SD3_CTRL_FUNCSEL &FUNCSEL, IO_QSPI_OVER &OUTOVER,
        IO_QSPI_OEOVER &OEOVER, IO_QSPI_OVER &INOVER,
        IO_QSPI_OVER &IRQOVER) volatile
    {
        uint32_t curr = GPIO_QSPI_SD3_CTRL;
