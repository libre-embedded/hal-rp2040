...
#pragma once
#ifndef RP2040_STRUCTS_USBCTRL_REGS_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 29; /*!< usbctrl_regs's identifier. */
     ...
     * set in the buffer control register Raised by host if:
     ...
     * from DPSRAM The host can raise a data sequence error in the following
     * conditions:
...
static_assert(ifgen_struct<usbctrl_regs>);
