...
struct adc
{
  ...
  will start conversions at regular intervals rather than back-to-back. The
  divider is reset when either of these fields are written. Total period is 1 +
  INT + FRAC / 256 */
     ...
     * channel in a round-robin fashion. The first channel to be sampled will
     * be the one currently indicated by AINSEL. AINSEL will be updated after
