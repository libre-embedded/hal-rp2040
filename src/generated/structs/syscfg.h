...
#pragma once
#ifndef RP2040_STRUCTS_SYSCFG_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 22;   /*!< syscfg's identifier. */
    ...
    uint32_t PROC_IN_SYNC_BYPASS; /*!< (read-write) For each bit, if 1, bypass
             ...
             register in the SIO. The input synchronizers should generally be
             unbypassed, to avoid injecting metastabilities into processors. If
    ...
    uint32_t
        PROC_IN_SYNC_BYPASS_HI; /*!< (read-write) For each bit, if 1, bypass
           the input synchronizer between that GPIO and the GPIO input register
           in the SIO. The input synchronizers should generally be unbypassed,
           to avoid injecting metastabilities into processors. If you're
           feeling brave, you can bypass to save two cycles of input latency.
    ...
    uint32_t MEMPOWERDOWN; /*!< (read-write) Control power downs to memories.
      Set high to power down memories. Use with extreme caution */
     ...
     * debug access in multi-chip environment WARNING: do not set to 15 as this
     * is reserved for RescueDP
     */
     ...
     */
    inline uint32_t get_PROC_IN_SYNC_BYPASS() volatile
    {
        return PROC_IN_SYNC_BYPASS & 0b111111111111111111111111111111u;
    }

    /**
     * Set PROC_IN_SYNC_BYPASS's PROC_IN_SYNC_BYPASS field.
     */
    inline void set_PROC_IN_SYNC_BYPASS(uint32_t value) volatile
    {
     ...
     */
    inline uint8_t get_PROC_IN_SYNC_BYPASS_HI() volatile
    {
        return PROC_IN_SYNC_BYPASS_HI & 0b111111u;
    }

    /**
     * Set PROC_IN_SYNC_BYPASS_HI's PROC_IN_SYNC_BYPASS_HI field.
     */
    inline void set_PROC_IN_SYNC_BYPASS_HI(uint8_t value) volatile
    {
     ...
     * memories. Use with extreme caution
     */
