...
struct dma
{
  ...
  pointer   This register updates automatically each time a read completes. The
 ...
 pointer  This register updates automatically each time a write completes. The
...
number of bytes transferred (see CTRL_DATA_SIZE). When the channel is active,
reading this register shows the number of transfers remaining, updating
automatically each time a write transfer completes. Writing this register sets
the RELOAD value for the transfer counter. Each time this channel is triggered,
the RELOAD value is copied into the live transfer counter. The channel can be
started multiple times, and will perform the same number of transfers each
time, as programmed by most recent write. The RELOAD value can be observed at
...
final result can be read from this register. */
    ...
    {
        return (CH10_CTRL_TRIG >> 11u) & 0xfu;
    }
     ...
     */
    inline void get_CH10_CTRL_TRIG(bool &EN, bool &HIGH_PRIORITY,
                                   DMA_DATA_SIZE &DATA_SIZE, bool &INCR_READ,
                                   bool &INCR_WRITE, DMA_RING_SIZE &RING_SIZE,
                                   bool &RING_SEL, uint8_t &CHAIN_TO,
                                   DMA_TREQ_SEL &TREQ_SEL, bool &IRQ_QUIET,
    ...
    {
        return (CH11_CTRL_TRIG >> 11u) & 0xfu;
    }
     ...
     */
    inline void get_CH11_CTRL_TRIG(bool &EN, bool &HIGH_PRIORITY,
                                   DMA_DATA_SIZE &DATA_SIZE, bool &INCR_READ,
                                   bool &INCR_WRITE, DMA_RING_SIZE &RING_SIZE,
                                   bool &RING_SEL, uint8_t &CHAIN_TO,
                                   DMA_TREQ_SEL &TREQ_SEL, bool &IRQ_QUIET,
