...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 26;     /*!< uart's identifier. */
    ...
    std::array<const uint32_t, 4> reserved_padding0 = {};
    ...
    std::array<const uint32_t, 997> reserved_padding2 = {};
