...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 14;    /*!< pwm's identifier. */
    static constexpr std::size_t size = 180; /*!< pwm's size in bytes. */

    /* Fields. */
    uint32_t CH0_CSR; /*!< (read-write) Control and status register */
    uint32_t CH0_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
    ...
    uint32_t CH1_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH2_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH3_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH4_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH5_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH6_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
    ...
    uint32_t CH7_DIV; /*!< (read-write) INT and FRAC form a fixed-point
        fractional number. Counting rate is system clock frequency divided by
        this number. Fractional division uses simple 1st-order sigma-delta. */
     ...
     *                 Self-clearing. Write a 1, and poll until low. Counter
     * must be running at less than full speed (div_int + div_frac / 16 > 1)
     */
    ...
    inline void get_CH0_CSR(bool &EN, bool &PH_CORRECT, bool &A_INV,
                            bool &B_INV, PWM_DIVMODE &DIVMODE, bool &PH_RET,
    ...
    inline void set_CH0_CSR(bool EN, bool PH_CORRECT, bool A_INV, bool B_INV,
                            PWM_DIVMODE DIVMODE, bool PH_RET,
                            bool PH_ADV) volatile
    {
        uint32_t curr = CH0_CSR;
     ...
     * number. Fractional division uses simple 1st-order sigma-delta.
     */
