...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 23;    /*!< sio's identifier. */
...
REMAINDER. UDIVIDEND/SDIVIDEND are aliases of the same internal register. The U
...
is low. For signed calculations, REMAINDER is negative only when DIVIDEND is
negative. This register can be written to directly, for context save/restore
purposes. This halts any in-progress calculation and sets the CSR_READY and
CSR_DIRTY flags. */
